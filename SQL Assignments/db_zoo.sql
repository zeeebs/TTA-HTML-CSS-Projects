...
INSERT INTO tbl_persons
	...
	('mary', 'ana', '012-345-6789'),
	('tex', 'burns', '098-765-4321'),
	('sally', 'fields', '987-654-3210'),
	('gerry', 'kerns', '111-222-3333')
;
...
SELECT persons_fname AS 'Firstname', persons_lname 'Lastname', persons_contact AS 'Phone' FROM tbl_persons WHERE persons_fname LIKE 'm%' ORDER BY persons_lname;
...
INSERT INTO tbl_species
	...
	('ghost bat', 1, 102, 1, 5007, 2204, 'care_4'),
...
IF EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.TABLES tbl_species)
	DROP TABLE tbl_species, tbl_animalia, tbl_care, tbl_class, tbl_habitat, tbl_nutrition, tbl_order, tbl_specialists;
